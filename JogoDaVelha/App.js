...
export default function App() {
  ...
  const changeMove = (number) => {
    ...
    const winGame = (number) => {
      if(
        // Linhas Iguais
        (array[0] === aray[number] && aray[1] === array[number] && array[2] === array [number])
        ||
        (array[3] === aray[number] && aray[4] === array[number] && array[5] === array [number])
        ||
        (array[6] === aray[number] && aray[7] === array[number] && array[8] === array [number])
        
        //Colunas Iguais
        (array[0] === aray[number] && aray[3] === array[number] && array[6] === array [number])
        ||
        (array[1] === aray[number] && aray[4] === array[number] && array[7] === array [number])
        ||
        (array[2] === aray[number] && aray[5] === array[number] && array[8] === array [number])

        //Diagonais iguais
        (array[0] === aray[number] && aray[4] === array[number] && array[8] === array [number])
        ||
        (array[2] === aray[number] && aray[4] === array[number] && array[6] === array [number])
      ) {
